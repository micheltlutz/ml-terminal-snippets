...
| **Projetos** | Wizard → esqueleto Swift (macOS/iOS/SPM), `README.md`, `AGENTS.md`, `.gitignore` (template), `.cursor/skills/` + regras, `git init` opcional |
...
| [0007](docs/adr/0007-swift-skeleton-and-gitignore-templates.md) | Esqueleto Swift + templates .gitignore |
